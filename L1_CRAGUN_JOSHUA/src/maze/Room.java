...
public class Room extends JPanel
{
    ...
    /**
     * Returns a list of all the rooms that are separated from this room with solid walls.
     */
    ...
    /**
     * Returns the room on the other side of the door in the specified direction
     * 
     * @param face "N", "E", "S", or "W"
     */
    ...
    /**
     * Adds a stain, and throws in a delay for the purposes of animation.
     */
    ...
    /**
     * Removes a stain, and throws in a delay for the purposes of animation.
     */
    ...
    private Color setColors ()
    {
        ...
        return new Color((float) Math.pow(red / stains.size(), 1 / gamma),
                (float) Math.pow(green / stains.size(), 1 / gamma), (float) Math.pow(blue / stains.size(), 1 / gamma));
    }
}
