...
/**
 * Provides a searchable maze as a JPanel that can be incorporated into a GUI. There is always a unique path between any
 * two rooms.
 * 
...
public class Maze extends JPanel
{
    ...
    /**
     * Returns the room at the specified row and column, or null if there is no such room.
     */
    ...
    /**
     * Carves a maze. All the rooms are required to have four walls when this method is called.
     * 
