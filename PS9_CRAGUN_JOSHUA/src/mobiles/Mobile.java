...
public class Mobile
{
    ...
    public int weight ()
    {
        ...
        {
            return this.right.weight() + this.left.weight();
        }
    }
    ...
    public boolean isBalanced ()
    {
        ...
        {
            return (this.leftLength * this.left.weight() == this.rightLength * this.right.weight()) && (this.left.isBalanced() && this.right.isBalanced());
        }
    }
    ...
    public int rodCount ()
    {
        ...
        {
            return 1 + this.left.rodCount() + this.right.rodCount();
        }
    }
    ...
    public int longestRod ()
    {
        ...
        {
            int temp = Math.max(this.leftLength, this.rightLength);
            return Math.max(Math.max(temp, this.left.longestRod()), Math.max(temp, this.right.longestRod()));
        }
    }
